...
char				*ft_strjoin2(const char *s1, const char *s2, size_t len1,
						size_t len2);
...
char				*ft_strtrim2(const char *s, const char *set, size_t s_len,
						size_t set_len);
char				*ft_substr(const char *s, unsigned start, size_t n);
char				*ft_substr2(const char *s, size_t len, unsigned int start,
						size_t n);
